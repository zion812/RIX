...
exports.processVideo = exports.processImage = void 0;
 ...
 */
async function generateImageVariant(inputPath, outputDir, baseName, quality, options) {
 ...
 */
async function generateVideoVariant(inputPath, outputDir, baseName, quality, options) {
 ...
 */
async function generateVideoThumbnail(inputPath, outputDir, baseName) {
    return new Promise((resolve, reject) => {
 ...
 */
function getProcessingConfig(filePath) {
 ...
 */
async function updateMediaMetadata(filePath, processedFiles, config) {
 ...
 */
async function updateVideoMetadata(filePath, processedFiles) {
    const pathParts = filePath.split('/');
    if (pathParts.length < 4)
        return;
    const userId = pathParts[1];
...
//# sourceMappingURL=mediaProcessing.js.map